...
class TestSteelEye(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        Class method calls once at the beginning of unit test (Prateek Verma)
        """
    ...
    def setUp(self):
        """Instance Method called everytime before a test case is executed (Prateek Verma)"""
    ...
    def test_parse_source_xml(self):
        """Function to test parse_source_xml function (Prateek Verma)"""
        ...
        # present in the download path (Prateek Verma)
        self.assertEqual(
    ...
    def test_unzip_file(self):
        """Function to test unzip_file function (Prateek Verma)"""
    ...
    def test_create_csv(self):
        """Function to test create_csv funtion (Prateek Verma)"""
    ...
    def aws_s3_upload(self):
        ...
        # absolute path to the csv file to create (Prateek Verma)
        csv_file = os.path.join(self.csvfile, "DLTINS_20210117_01of01.csv")
